                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;" id="main_category" name="category_id">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="input-group">
                                              <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="videos">Choose videos</label>
                                              </div>
                                            </div>
                                          </div>
                                        </div> --}}
                            ...
                            <div class="card-body">
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($tourPackages as $package)
                                        <tr>
                                            <td>{{ $package->id }}</td>
                                            <td>{{ $package->category ? $package->category->category_name : '' }}</td>
                                            <td>{{ $package->subCategory ? $package->subCategory->category_name : '' }}</td>
                                            <td>{{ $package->amount }}</td>
                                            <td>{{ $package->no_of_days }}</td>
                                            <td>{{ $package->guide ? $package->guide->name : '' }}</td>

                                            <td class="action-icons">
                                                <a href="{{ route('admin.default_tour.view', $package->id) }}" class="btn btn-primary">
                                                    <i class="far fa-eye"></i> <span>View</span>
                                                </a>
                                                <a href="{{ route('admin.default_tour.edit', $package->id) }}" class="btn btn-warning">
                                                    <i class="fas fa-edit"></i> <span>Edit</span>
                                                </a>
                                                <form action="{{ route('admin.default_tour.delete', $package->id) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
...
// Fetch Inclusions
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, value) {
                                $('#guide_id').append('<option value="'+ value.id +'">'+ value.name +'</option>');
                            });
                        }
                    });
