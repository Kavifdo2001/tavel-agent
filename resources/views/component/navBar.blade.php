...
<style>
    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0" style="background-color: #543495">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="{{route('packages')}}" class="nav-item nav-link @if(request()->routeIs('packages'))active @endif">Tours</a>
                    <a href="{{route('gallery')}}" class="nav-item nav-link @if(request()->routeIs('gallery'))active @endif">Gallery</a>
